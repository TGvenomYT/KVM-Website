      ...
      {course && (
        ...
        >
          ...
          >
            ...
            <CourseTimetable timetable={course.timetable} />
...
function CourseTimetable({ timetable }) {
  ...
  return (
    <section className="relative px-6 py-12 md:px-12 md:py-14">
      <SectionHeader
        ...
        title="The Schedule"
        subtitle="Indicative timings — final slots confirmed at enrolment"
        icon={Calendar}
      />
      ...
      <div className="mt-10 space-y-5">
        {timetable.map((day, dayIdx) => (
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: dayIdx * 0.06, ease: [0.22, 1, 0.36, 1] }}
